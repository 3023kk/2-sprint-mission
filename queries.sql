...
/*
  6. 상품 생성
  - 현재 로그인한 유저 id가 1이라고 가정
  INSERT INTO products (title, description, price, user_id, created_at)
  VALUES ('새 신발', '한 번도 안 신은 신발 팝니다', 30000, 1, NOW());
